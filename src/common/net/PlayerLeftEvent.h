...
class PlayerLeftEvent : public InGameEvent {
  ...
  public:
    PlayerLeftEvent(QuitReason reason, quint8 character_id, quint32 id, quint32 timestamp);
    PlayerLeftEvent(QuitReason reason, quint8 character_id, quint32 timestamp);
